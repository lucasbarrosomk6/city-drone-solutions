...
export const productSlice = createSlice({
  ...
  reducers: {
    ...
    getTotal: (state, { payload }) => {
      let { total, quantity } = state.addToCart.reduce((cartTotal, cartItem) => {
...
export const { addToProduct, removeProduct, decreaseCart, getTotal,specificItem,clearCart,addToWishList,removeWishListProduct } = productSlice.actions;
